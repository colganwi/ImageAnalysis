function [varargout] = COG(A, varargin)		
 ...
 % [Loc1, Loc2] = COG(A) finds the center of gravity of the 2D Matrix A
 ...
 % is a 2x3 matrix, then coordVec1 is a 2element vector, and coordVec2 is a
 % 3element vector.
 %
 ...
 % where coordVec1 is a 9element vector.
 %
 ...
 if nargout<=1 &&  sum(S>1)==1  % if only one nonsingleton dimension
